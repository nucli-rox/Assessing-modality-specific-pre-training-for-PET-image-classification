"""
Classification training script — logs to MLflow.
See train_clf_WANDB.py for the Weights & Biases variant.
"""
...
def main(args):
    ...
    for local_idx, (train_idx, val_idx) in enumerate(split_indices):
        ...
        train_loader, val_loader = build_dataloaders(
            train_files, val_files, transforms_cfg, dl_cfg
        )
        ...
        fold_summaries.append(
            fold_summary_entry(fold_id, train_files, val_files, history)
        )
